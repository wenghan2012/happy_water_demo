 ...
 * @Author: 快乐水 樱桃可乐
 * @Description:
 * @Date: Created in 11:12 2018/10/27
 * @Modified By:
 */
public class ManagerJoin {
    ...
    public String toString() {
        return "ManagerJoin{" + "id=" + id + ", serialId='" + serialId + '\'' + ", account='" + account + '\'' + ", password='" + password + '\'' + ", salt='" + salt + '\'' + ", locked=" + locked + ", createdBy='" + createdBy + '\'' + ", updatedBy='" + updatedBy + '\'' + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt + ", roleName=" + roleName + '}';
    }
}
